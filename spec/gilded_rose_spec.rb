...
describe GildedRose do
  ...
  describe "#update_quality" do
    ...
    describe 'for aged brie' do
      ...
      before(:each) do
        @items = [Item.new("Aged Brie", 3, 4), Item.new("Aged Brie", 0, 4), Item.new("Aged Brie", -1, 49), Item.new("Aged Brie", 3, 50)]
        @shop = GildedRose.new(@items)
      end
      ...
      it "unless increasing by 2 would take quality beyong 50" do
